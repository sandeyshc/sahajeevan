...
export const premiumMatches = async () => {
    return await APICall(
        process.env.REACT_APP_BASE_URL + URLS.PREMIUM
    );
};
...
export const sentInterests = async () => {
    return await APICall(
        process.env.REACT_APP_BASE_URL + URLS.SENTINTERESTS
    );
};

export const shortlisted = async () => {
    return await APICall(
        process.env.REACT_APP_BASE_URL + URLS.SHORTLISTED
    );
};

export const acceptedByMe = async () => {
    return await APICall(
        process.env.REACT_APP_BASE_URL + URLS.ACCEPTEDBYME
    );
};

export const acceptedByOthers = async () => {
    return await APICall(
        process.env.REACT_APP_BASE_URL + URLS.ACCEPTEDME
    );
};
